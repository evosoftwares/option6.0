...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF112442);
  late Color tertiary = const Color(0xFFB71981);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF4D525C);
  late Color primaryBackground = const Color(0xFFF1F1F1);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C3962EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF0044);
  late Color info = const Color(0xFFFFFFFF);

  late Color customColor1 = const Color(0xFF8AB5B0);
  late Color customColor2 = const Color(0xFFBBBAA1);
}
