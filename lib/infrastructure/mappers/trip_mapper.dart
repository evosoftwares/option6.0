...
class TripMapper {
  Trip toDomain(TripsRow row) {
    return Trip(
      ...
      estimatedDistanceKm: row.estimatedDistanceKm ?? 0,
      actualDistanceKm: row.actualDistanceKm ?? 0,
      actualDurationMinutes: row.actualDurationMinutes ?? 0,
      waitingTimeMinutes: row.waitingTimeMinutes ?? 0,
      ...
      driverAssignedAt: row.driverAssignedAt ?? DateTime.now(),
      driverArrivedAt: row.driverArrivedAt ?? DateTime.now(),
      tripStartedAt: row.tripStartedAt ?? DateTime.now(),
      tripCompletedAt: row.tripCompletedAt ?? DateTime.now(),
      cancelledAt: row.cancelledAt ?? DateTime.now(),
      paymentStatus: row.paymentStatus ?? '',
      paymentId: row.paymentId ?? '',
      promoCodeId: row.promoCodeId ?? '',
      discountApplied: row.discountApplied ?? 0.0,
      updatedAt: row.updatedAt ?? DateTime.now(),
      startTime: row.startTime ?? DateTime.now(),
      endTime: row.endTime ?? DateTime.now(),
      requestedAt: row.requestedAt ?? DateTime.now(),
